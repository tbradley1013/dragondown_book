...
\NormalTok{pkg <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"dplyr"}\NormalTok{, }\StringTok{"ggplot2"}\NormalTok{, }\StringTok{"knitr"}\NormalTok{, }\StringTok{"bookdown"}\NormalTok{, }\StringTok{"devtools"}\NormalTok{, }\StringTok{"kableExtra"}\NormalTok{)}
...
\CommentTok{# Load packages (daragondown will load all of the packages as well)}
...
\KeywordTok{kable}\NormalTok{(max_delays, }
      ...
      \DataTypeTok{longtable =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{booktabs =} \OtherTok{TRUE}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
...
\midrule
\endfirsthead
\caption[]{\label{tab:maxdelays}Maximum Delays by Airline \textit{(continued)}}\\
\toprule
Airline & Max Arrival Delay\\
\midrule
\endhead
